      ...
      <section style="padding: 2rem 0;">
        ...
        ${
          user.verifiedVeteran
            ? `
        <div style="background: rgba(34, 197, 94, 0.1); border: 1px solid rgba(34, 197, 94, 0.2); border-radius: 0.5rem; padding: 1.5rem; margin-bottom: 2rem;">
        ...
        `
            : user.pendingVerification
              ? `
        <div style="background: rgba(234, 179, 8, 0.1); border: 1px solid rgba(234, 179, 8, 0.2); border-radius: 0.5rem; padding: 1.5rem; margin-bottom: 2rem;">
