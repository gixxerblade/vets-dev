...
Note: For complete API reference including request/response schemas and all parameters, see:
...
Note: For complete details on the Files API, see the [Files API documentation](/docs/en/api/files-content).
